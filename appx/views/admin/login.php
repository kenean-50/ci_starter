   			...
   			<div class="login-box-body">
				...
				<?php echo form_open('admin/login', 'class="form-login"')?>
					<div class="form-group has-feedback">
						<input type="text" name="identity" class="form-control" value="<?= set_value('identity')?>" placeholder="<?php echo $this->lang->line('login_identity_label'); ?>" autofocus>
						<span class="glyphicon glyphicon-envelope form-control-feedback"></span>
						<?php echo form_error('email'); ?>
					</div>
					<div class="form-group has-feedback">
						<input type="password" class="form-control" name="password" value="<?= set_value('password')?>"  placeholder="<?php echo $this->lang->line('login_password_label'); ?>">
					...
					<div class="row">
						<div class="col-xs-4">
							<button type="submit" name="submit" class="btn <?php echo setting_all('buttons'); ?> btn-block btn-flat"> <?php echo $this->lang->line('login_submit_btn'); ?></button>
						</div>
					</div>
				<?php echo form_close();?>
				<br>
